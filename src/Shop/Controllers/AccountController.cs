...
namespace Shop.Controllers
{
    ...
    public class AccountController : Controller
    {
                ...
                case SignInStatus.Success:
                    {
                        ...
                        if (AuthAdmin(kh) == true)
                        {
                            ...
                            return RedirectToAction("Index", "Administrator/Laptop");
                        }
                        else
                        {
        ...
        // TEMP: Reset tat ca password ve 123456
        [AllowAnonymous]
        public ActionResult ResetAllPasswords()
        {
            ...
            {
                var r1 = userManager.RemovePassword(user.Id);
                var r2 = userManager.AddPassword(user.Id, "Admin@123456");
                log += user.Email + ": RemovePassword=" + r1.Succeeded + ", AddPassword=" + r2.Succeeded + "<br/>";
            }
            return Content(log);
        }
